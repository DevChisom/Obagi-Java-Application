public class Operators{
  ...
  int difference = num1 - num2;
    ...
    //if you want the reminder to remain, simply cast it 
  ...
  //Logical Operator - used to make decisions and along with a relational operator (&& [and},||[or], ![not]);
  ...
  System.out.printf("The diference between %d and %d is : %d%n", num1,num2,difference);
